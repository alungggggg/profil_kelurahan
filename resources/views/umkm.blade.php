               ...
               <div class="card rounded-0 mb-4">
                   <div class="row">
                       <div class="fables-product-img col-12">
                          <center><img style="width:225px; height:225px; overflow:hidden; position:relative;" class="card-img-top rounded-0" src="{{ asset($umkm->image) }}" alt="dress fashion"></center>
                      ...
                      <div class="card-body col-12">
                        <h5 class="card-title mx-3">
                            <a href="#" class="font-15 font-weight-bold fables-second-text-color my-2 mx-3">{{ $umkm->nama_toko }}</a>
                        </h5>
                        <p class="card-text fables-fifth-text-color font-15 mx-3 mb-2">{{ $umkm->description }}</p>
                        <a class="btn fables-second-background-color text-white" href="{{ $umkm->location }}">Location</a>
                        <a class="btn btn-success text-white" href="wa.me/{{ $umkm->nomor }}">Order Now!</a>
                      </div>
                   </div>
                </div>
           </div> 
