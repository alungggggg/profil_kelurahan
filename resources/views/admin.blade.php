        ...
        <div class="container">
            <div class="row mt-5">
                @if (Auth::user()->role_id == 2)
                    <div class="col-6 col-md-4 mb-4 mb-lg-5">
                        <div class="card fables-team-block fables-team-data-hover fables-second-border-color mb-4 mb-sm-0">
                            <img class="w-100" src="{{ asset('/asset/image/lkk.png') }}" alt="Card image cap">
                            <div class="card-body">
                    ...
                    <div class="col-6 col-md-4 mb-4 mb-lg-5">
                        <div class="card fables-team-block fables-team-data-hover fables-second-border-color mb-4 mb-sm-0">
                            <img class="w-100" src="{{ asset('/asset/image/fk.png') }}" alt="Card image cap">
                            <div class="card-body">
                    ...
                    <div class="col-6 col-md-4 mb-4 mb-lg-5">
                        <div class="card fables-team-block fables-team-data-hover fables-second-border-color mb-4 mb-sm-0">
                            <img class="w-100" src="{{ asset('/asset/image/user.png') }}" alt="Card image cap">
                            <div class="card-body">
                ...
                <div class="col-6 col-md-4 mb-4 mb-lg-5">
                    <div class="card fables-team-block fables-team-data-hover fables-second-border-color mb-4 mb-sm-0">
                        <img class="w-100" src="{{ asset('/asset/image/artikel.png') }}" alt="Card image cap">
                        <div class="card-body">
                ...
                <div class="col-6 col-md-4 mb-4 mb-lg-5">
                    <div class="card fables-team-block fables-team-data-hover fables-second-border-color mb-4 mb-sm-0">
                        <img class="w-100" src="{{ asset('/asset/image/umkm.png') }}" alt="Card image cap">
                        <div class="card-body">
