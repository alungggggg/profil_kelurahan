...
<div class="container">
            <div class="my-4 my-md-5 overflow-hidden">
                ...
                <div class="text-center mb-5 wow fadeInDown" data-wow-delay="1s">
                    ...
                    <h2 class="fables-second-text-color mt-3 font-30 font-weight-bold text-center">Chatbot WhatsApp Kelurahan Ngampel</h2> 
                </div> 
    ...
    <div class="owl-carousel owl-theme fables-second-dots default-carousel nav-0">
          <div class="gallery-history-slider">
               <div class="row mb-4 my-lg-5">
                   ...
                   <div class="col-12 col-sm-4 text-center circles">
                       <span class="fables-fifth-text-color font-15">Informasi Lengkap Anda Dapatkan Dengan Mudah</span>
                       <span class="fables-gallery-circle fables-main-background-color fables-second-before"></span>
                   </div>
               </div>
            </div>
