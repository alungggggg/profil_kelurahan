...
<body>
                    ...
                    <nav class="navbar fables-main-background-color navbar-expand-md btco-hover-menu py-lg-2">
                        ...
                        <div class="collapse navbar-collapse" id="fablesNavDropdown">
                            ...
                            <ul class="navbar-nav mx-auto fables-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#" id="sub-nav1" data-toggle="dropdown"
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-lg-2">
                <a href="#"><img src="{{ asset('/asset/image/navngampel.png') }}"
                        class="fables-logo w-50"></a>
            </div>
        </div>
    </div><br>
    ...
    <div class="fables-page-content container overflow-hidden">
        ...
        <center><img width="50%" src="{{ asset('/asset/image/apk.png') }}"
    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-9 p-0 wow fadeInRightBig" data-wow-duration="4s">
            <div class="mb-5 image-container translate-effect-right">
                <div class="p-6">
                    <h1 class="text-white font-29 semi-font">
                ...
                @foreach ($articles as $article)
                    <div class="col-12 col-sm-4 col-md-4 mb-4 mb-lg-5">
                        ...
                        <h2 class="font-weight-bold mt-3 mb-2 font-18 semi-font"><a href="#"
                                class="fables-second-text-color fables-second-hover-color">{{ $article->title }}</a>
                        </h2>
        ...
        <div id="cd-timeline" class="cd-container gallery-timeline my-4 my-md-5">
            ...
            <div class="cd-timeline-block">
                ...
                <div class="cd-timeline-content">
                    <a href="#"><img src="{{ asset('/asset/image/kucing.jpg') }}" alt=""
                            class="w-100"></a>
                    <h2 class="font-15 semi-font px-3 mt-2"><a href="#"
                            class="fables-second-text-color fables-main-hover-color fables-gallery-timeline-head">
