                        ...
                        <div class="row">
                            <div class="fables-product-img col-12">
                                <center><img style="width:225px; height:225px; overflow:hidden; position:relative;"
                                        class="card-img-top rounded-0" src="{{ asset($article->thumbnail) }}"
                                        alt="dress fashion"></center>
                            ...
                            <div class="card-body col-12">
                                <h5 class="card-title mx-3">
                                    <a href="#"
                                        class="font-15 font-weight-bold fables-second-text-color my-2 mx-3">{{ $article->title }}</a>
                                </h5>
                                <p class="card-text fables-fifth-text-color font-15 mx-3">{!! substr($article->content, '0', '50') !!}...</p>
                                <p class="fables-product-info"><a href="/berita/{{ $article->title }}"
